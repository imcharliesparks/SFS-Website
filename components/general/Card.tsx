...
// TODO: Replace all image tags with priority to the next image package to reduce pop-in
export const Card = ({ imageProps, title, content, cardButtons }: Props) => (
	<div className="max-w-sm rounded overflow-hidden shadow-lg">
		{imageProps && imageProps.src && (
			<Image priority={true} className="w-full" {...imageProps} alt={imageProps.alt ?? 'No alt provided'} />
		)}
